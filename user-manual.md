...
* 9 - Режим сканирования спектра - режим, запускаемый по умолчанию. При первом запуске происходит накопление фона. При активном окне настроек переводит фокус на параметры данного режима.
